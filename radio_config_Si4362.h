...
// INPUT DATA
/*
// Crys_freq(Hz): 26000000    Crys_tol(ppm): 5.3    IF_mode: 2    High_perf_Ch_Fil: 1    OSRtune: 0    Ch_Fil_Bw_AFC: 1    ANT_DIV: 0    PM_pattern: 0    
// MOD_type: 3    Rsymb(sps): 600    Fdev(Hz): 300    RXBW(Hz): 150000    Manchester: 0    AFC_en: 1    Rsymb_error: 0.0    Chip-Version: 2    
// RF Freq.(MHz): 434.4    API_TC: 29    fhst: 250000    inputBW: 0    BERT: 0    RAW_dout: 0    D_source: 0    Hi_pfm_div: 1    
// 
// # RX IF frequency is  -406250 Hz
// # WB filter 3 (BW =  10.03 kHz);  NB-filter 15 (BW = 2.81 kHz)
// 
// Modulation index: 1
*/
...
*/
#define RF_GPIO_PIN_CFG 0x13, 0x11, 0x14, 0x00, 0x00, 0x00, 0x4B, 0x00
...
*/
#define RF_GLOBAL_XO_TUNE_1 0x11, 0x00, 0x01, 0x00, 0x3D
...
*/
#define RF_MODEM_MDM_CTRL_7 0x11, 0x20, 0x07, 0x19, 0x00, 0x08, 0x03, 0x80, 0x00, 0xB0, 0x10
...
*/
#define RF_PKT_LEN_3 0x11, 0x12, 0x03, 0x08, 0x2A, 0x01, 0x00
...
*/
#define RF_PKT_RX_THRESHOLD_12 0x11, 0x12, 0x0C, 0x0C, 0x30, 0x00, 0x01, 0x07, 0x00, 0x00, 0x10, 0x03, 0x00, 0x00, 0x00, 0x00
...
//   MODEM_FREQ_DEV_1 - 17-bit unsigned TX frequency deviation word.
*/
#define RF_MODEM_MOD_TYPE_12_1 0x11, 0x20, 0x0C, 0x00, 0x03, 0x00, 0x07, 0x00, 0x5D, 0xC0, 0x05, 0x8C, 0xBA, 0x80, 0x00, 0x00
...
//   MODEM_FREQ_DEV_0 - 17-bit unsigned TX frequency deviation word.
*/
#define RF_MODEM_FREQ_DEV_0_1_1 0x11, 0x20, 0x01, 0x0C, 0x18

/*
// Set properties:           RF_MODEM_MDM_CTRL_7_1
// Number of properties:     7
// Group ID:                 0x20
// Start ID:                 0x19
// Default values:           0x00, 0x08, 0x03, 0xC0, 0x00, 0x10, 0x20, 
...
//   MODEM_DECIMATION_CFG0 - Specifies miscellaneous parameters and decimator ratios for the Cascaded Integrator Comb (CIC) filter.
*/
#define RF_MODEM_MDM_CTRL_7_1 0x11, 0x20, 0x07, 0x19, 0x00, 0x08, 0x03, 0x80, 0x00, 0xB0, 0x21
...
//   MODEM_BCR_MISC1 - Miscellaneous control bits for the RX BCR loop.
*/
#define RF_MODEM_BCR_OSR_1_9_1 0x11, 0x20, 0x09, 0x22, 0x02, 0xA5, 0x00, 0xC1, 0x95, 0x00, 0xC2, 0x02, 0x00
...
//   MODEM_AFC_MISC - Specifies miscellaneous AFC control bits.
*/
#define RF_MODEM_AFC_GEAR_7_1 0x11, 0x20, 0x07, 0x2C, 0x00, 0x12, 0xC0, 0x06, 0x0E, 0xD2, 0xE0
...
//   MODEM_OOK_PDTC - Configures the attack and decay times of the OOK Peak Detector.
*/
#define RF_MODEM_AGC_WINDOW_SIZE_9_1 0x11, 0x20, 0x09, 0x38, 0x11, 0x94, 0x94, 0x00, 0x1A, 0x40, 0x00, 0x00, 0x2B
...
*/
#define RF_MODEM_OOK_CNT1_9 0x11, 0x20, 0x09, 0x42, 0xA4, 0x03, 0xD6, 0x03, 0x00, 0x1C, 0x01, 0x80, 0x50
...
//   MODEM_CHFLT_RX2_CHFLT_COE8_7_0 - Filter coefficients for the second set of RX filter coefficients.
*/
#define RF_MODEM_CHFLT_RX1_CHFLT_COE1_7_0_12_1 0x11, 0x21, 0x0C, 0x0C, 0x0A, 0x04, 0x15, 0xFC, 0x03, 0x00, 0xA2, 0xA0, 0x97, 0x8A, 0x79, 0x66
...
//   FREQ_CONTROL_VCOCNT_RX_ADJ - Adjust target count for VCO calibration in RX mode.
*/
#define RF_FREQ_CONTROL_INTE_8_1 0x11, 0x40, 0x08, 0x00, 0x41, 0x0E, 0xA5, 0x6A, 0x4E, 0xC5, 0x20, 0xFE
